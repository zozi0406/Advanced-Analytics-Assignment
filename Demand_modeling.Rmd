...
g1<-ggplot(optimisation_set,aes(x=WEEK,y=PRICE))+geom_line()
g2<-ggplot(optimisation_set,aes(x=WEEK,y=MOVE))+geom_line()
g3<-ggplot(optimisation_set,aes(x=WEEK,y=profit_on_sales))+geom_line()
...
g1<-ggplot(excel_output,aes(x=WEEK,y=Price))+geom_line()
g2<-ggplot(excel_output,aes(x=WEEK,y=Predicted_sales))+geom_line()
g3<-ggplot(excel_output,aes(x=WEEK,y=Predicted_profit))+geom_line()
grid.arrange(g1,g2,g3,nrow=3)
